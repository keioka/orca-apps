  ...
  return (
    <Box pb={8}>
      ...
      <Typography sx={{ fontFamily: "Crimson Text", fontSize: 18, color: "#242424", padding: 2 }}>
        Humane, an innovative AI startup founded by former Apple executives, has announced a significant partnership with South Korea's SK Telecom. This collaboration marks Humane's first venture into international markets, involving the licensing of its CosmOS operating system and the introduction of its AI Pin device. With a strategic focus on expanding its global footprint, Humane delays its US launch to mid-April amid anticipation​​​​.

        The AI Pin, priced at $699 with a $24 monthly subscription, is a wearable device designed to project information onto surfaces, aiming to reduce screen time and enhance user interaction with the digital world. Despite its unique features and generative AI capabilities, it faces criticism for practicality concerns and has yet to ship any devices to consumers. The partnership with SK Telecom not only opens new revenue opportunities but also aligns with SK's AI initiatives​​​​.

        As Humane navigates its US launch delays and the recent layoffs, the timeline for the AI Pin's availability in South Korea remains uncertain. The partnership signifies a step towards integrating cutting-edge AI technology into everyday life, though its success and consumer adoption in the competitive tech landscape are yet to be seen​​​​.
      </Typography>
      {shouldShowTrans &&
        <TransP>
          <Typography>
